...
dopri_data* dopri_data_alloc(deriv_func* target, size_t n,
  ...
  Rprintf("sizeof(return_code) = %d\n", sizeof(return_code));
  Rprintf("sizeof(dopri_method) = %d\n", sizeof(dopri_method));
  Rprintf("sizeof(SEXP) = %d\n", sizeof(SEXP));
  Rprintf("sizeof(dopri_verbose) = %d\n", sizeof(dopri_verbose));
  Rprintf("sizeof(bool) = %d\n", sizeof(bool));
...
//obj->sign * obj->times[obj->times_idx] <= obj->sign * obj->t);
  //    Rprintf("condition: %d, a: %d, b: %d\n", 
    //          condition, 
              obj->times_idx < obj->n_times,
              obj->sign * obj->times[obj->times_idx] <= obj->sign * obj->t);
      Rprintf("part 2: %d\n", 
              obj->times[obj->times_idx] <= obj->sign);
     */
      ...
      while ((obj->times_idx < obj->n_times &&
       ...
       Rprintf("interpolating time %d / %d\n", obj->times_idx, obj->n_times);
